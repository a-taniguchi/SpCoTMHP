...
from . import gmm_full
import serket as srk
import numpy as np
import os


class GMM_FULL(srk.Module):
    def __init__( self, K, itr=100, name="gmm_full", category=None, load_dir=None ):
        super(GMM_FULL, self).__init__(name, True)
        self.__K = K
        self.__itr = itr
