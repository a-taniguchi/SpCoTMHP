...
####################Parameters####################
DATA_NUM = 50 #100      # The number of training data
...
speech_folder = inputfolder + "speech/*.wav" #"/home/*/Dropbox/Julius/directory/SpCoSLAM/*.wav" #*.wav" #音声の教示データフォルダ(Ubuntuフルパス)
