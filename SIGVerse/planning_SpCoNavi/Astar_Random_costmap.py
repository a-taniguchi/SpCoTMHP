...
###########################################################
# Path-Planning Program by A star algorithm (ver. Goal Random selection) with costmap
# Akira Taniguchi 2019/06/24-2019/07/02-2019/09/11
# Spacial Thanks: Ryo Ozaki
###########################################################

##Command: 
#python ./Astar_Random_costmap.py trialname mapname iteration sample init_position_num speech_num
#python ./Astar_Random_costmap.py 3LDK_01 s1DK_01 1 0 0 0
...
outputname = outputfile + "Astar_costmap_Random_"+"N"+str(N_best)+"A"+str(Approx)+"S"+str(start)+"G"+str(speech_num)
...
candidate_num = []
#Word index in the all of training dataを取得
